...
# Bind the buffer to the GL_ELEMENT_ARRAY_BUFFER type target
gl.glBindBuffer(gl.GL_ELEMENT_ARRAY_BUFFER, ebo)
# modify the gl element array buffer, which is currently the ebo
...
# Visualize the rectangle as a wireframe
...
while not glfw.window_should_close(window):
    ...
    gl.glDrawElements(
        gl.GL_TRIANGLES,
        len(indices),  # Number of elements to draw
        gl.GL_UNSIGNED_INT,  # Type of the indices
        None  # Offset in the buffer (None means start at the beginning)
    )
