...
- [[decisions/index|Decisions]] (11 articles) — ADR-style records of architectural choices, all derived from code analysis (rationale inferred — see each article for the disclaimer)
