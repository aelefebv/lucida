...
- [[principles/upload-pipeline]] — what the CPU → GPU hand-off optimizes for: one hand-off path, cold-state authority, soft byte budget, single tracker, per-dataset state, bounded worker feedback
