...
| 6 | Biologist | As a biologist, I want an overview view when I get lost so I can quickly reorient myself. | CLI | Run viewer overview capture. | Overview PNG is created and nonblank. | Pass | Headless overview now waits for the app's render-ready signal and produced a nonblank PNG in targeted smoke testing. |
