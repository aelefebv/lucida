...
- *Wiki fallout*: Flow: Proxy Generation, Proxy Generator Priority Is Not Honored Yet (the priority scheduler will now never land — this closes the 2026-04-18 queue question), lucida-proxy, and the "still wired" language in lucida-server all become historical when the follow-up lands. ADRs [0004](0004-multi-pool-atlases.md)/[0024](0024-catalog-degrade-one-tier-at-a-time.md)/[0025](0025-groups-as-planning-unit.md)/[0038](0038-budgeted-proxy-gpu-residency.md) already record their superseded status.
...
- The queue items on proxy-generation priority (2026-04-18) and disabled-mode bookmark ownership (2026-05-07/08) close against this ADR — see Queue — Open Questions.
...
- Workspaces, Saved Views, lucida-server
