...
# React 18 Strict-Mode Kills One-Shot `destroy()` Classes
...
In Lucida today, only `UrlSync` matches the pattern after the fix in PR #483. New code in this shape needs the re-arm pattern.
