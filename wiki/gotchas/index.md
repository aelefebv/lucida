...
- [Explicit Translations Are in Physical Units; Lucida Composes in Voxels](stage-translations-are-microns.md) — OME-Zarr stores explicit tile translations in physical units; `lucida-store` converts to voxels at import
