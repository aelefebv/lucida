...
- **2026-05-07 → 2026-06-10** — Three gotchas suspected stale after OME-Zarr and build cleanup were re-checked. [[gotchas/preexisting-ts-build-errors]] is explicitly historical/resolved; [[gotchas/blosc-support]] describes the current intentionally narrow Blosc1 + zstd subset and import-time rejection behavior; [[gotchas/non-canonical-axes]] describes current pinned-axis and post-decode byte-slicing behavior. No open refresh item remains.
