...
- **2026-04-18** — Proxy generator priority is "FIFO today, scheduler later" ([Proxy Generator Priority Is Not Honored Yet](gotchas/proxy-priority-not-honored.md)). Is the priority scheduler scheduled, or has the team decided FIFO is fine indefinitely?
