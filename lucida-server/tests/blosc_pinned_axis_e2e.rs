...
const ENC_6D_BLOSC: &[u8] = &[
    0x02, 0x01, 0x96, 0x02, 0x40, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0x50, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x00, 0x03, 0x00, 0x04, 0x00, 0x05, 0x00,
    0x06, 0x00, 0x07, 0x00, 0x08, 0x00, 0x09, 0x00, 0x0a, 0x00, 0x0b, 0x00, 0x0c, 0x00,
    0x0d, 0x00, 0x0e, 0x00, 0x0f, 0x00, 0x64, 0x00, 0x65, 0x00, 0x66, 0x00, 0x67, 0x00,
...
async fn six_d_with_m_blosc_decodes_to_canonical_m0_slice() {
    ...
    let chunk_dir = level_dir.join("c").join("0").join("0").join("0").join("0").join("0");
