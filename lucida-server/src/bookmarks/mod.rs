//! Server-stored bookmarks (slice 2 of PRD #454, issue #475).
//!
...
//! same type the URL-hash side of the saved-views feature uses
//! (slice 1, ADR-0013) — so the two surfaces share a single schema and
//! a `#b=<id>` URL can be authored from any saved-view source.
//!
//! Module layout:
//!
