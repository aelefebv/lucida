...
//!
//! SQLite is the only implementation of this trait today, so `over:`
//! names one store. The suite is written against the trait all the same:
//! a second backend adds a factory here and inherits every case.
