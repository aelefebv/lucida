...
- `view.get.state`: [../templates/http/view-get.json](../templates/http/view-get.json)
...
- `view.move.pan`: [../templates/http/view-pan.json](../templates/http/view-pan.json)
- `view.move.zoom`: [../templates/http/view-zoom.json](../templates/http/view-zoom.json)
